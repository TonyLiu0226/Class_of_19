label apr_2019_lunch:
    ...
    tanish "Wait seriously? Does that mean she’s into guys who grind osu! at 3am?"

    alex "Bro if that’s the case you might have a chance"

    tanish "My 5000 combo on freedom dive is gonna carry this romance"
    ...
    tanish "Good morning, queen of recoil control"
    ...
    tanish "Yeah, we won’t be annoying. Probably."
    ...
    tanish "Plus the other options smelled like sadness."
    ...
    tanish "Yea this is why I don't use the microwaves."
