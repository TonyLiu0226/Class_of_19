label apr_2019_texting_2:

    stop music
    scene black
    show text "Later that same evening" with dissolve
    ...
    show phone at right
    play sound phone_ping
    alex "{i}guess i got lucky then{/i}"
    ...
    show phone at right
    play sound phone_ping
    alex "{i}ah okay, i prob should get back to work too, ill c u around{/i}"
